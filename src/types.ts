...
export interface CompactOptions {
  ...
  goal?: string;
  /**
   * Minimum Jev probability for a tool *result* to stay verbatim. Default 0.15:
   * a Noul of 0.5 means "unsure", so anything above a low floor is kept and
   * only a confident "no longer needed" truncates.
   */
